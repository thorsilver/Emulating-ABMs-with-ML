...
set.seed(123)
model <- train(
  x=svmtrain_df$x, y=svmtrain[,11], method = "svmRadial"
...
## write data to file
write.xlsx(predYtest, file="D:/E Documents/Social_care/SVM_R/Results/svm1600_nonlin_pred.xlsx",col.names=F, row.names=F, append=F)
write.xlsx(svmtest[,11], file="D:/E Documents/Social_care/SVM_R/Results/svm1600_nonlin_y.xlsx",col.names=F, row.names=F, append=F)
